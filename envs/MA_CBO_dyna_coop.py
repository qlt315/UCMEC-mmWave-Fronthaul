...
class MA_CBO_dyna_coop(object):
    def __init__(self, render: bool = False):
        ...
        self.N_sim = 200  # number of APs for simulation
        ...
        self.bandwidth_a = 2e7  # bandwidth of access channel
    ...
    def step(self, action):
        ...
        access_index_list = self.access_init(self.access_chan)
        uplink_rate_access = self.uplink_rate_cal(p_current, access_index_list, self.access_chan)
