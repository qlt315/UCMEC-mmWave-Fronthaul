...
class MA_MPO_dyna_noncoop(object):
    def __init__(self, render: bool = False):
        ...
        self.obs_dim = 4  # set the observation dimension of agents
        self.action_dim = 4
        self._render = render
    ...
    def step(self, action):
        ...
        for i in range(self.agent_num):
            if self.step_num == 1:
                observation[0] = Task_size[0, i]
                observation[1] = Task_density[0, i]
                observation[2] = 0
                observation[3] = 0
            else:
                observation[0] = Task_size[0, i]
                observation[1] = Task_density[0, i]
                observation[2] = self.omega_last[i]
                observation[3] = self.delay_last[i, 0]
